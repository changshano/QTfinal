...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_floor_direction->setAlignment(Qt::AlignCenter);
        ...
        tableView_ads->setSelectionMode(QAbstractItemView::SingleSelection);
        tableView_ads->setSelectionBehavior(QAbstractItemView::SelectRows);
